...
class _HodAttendanceScreenState extends State<HodAttendanceScreen>
  ...
  void _seedAllData() {
    // ── Regular workers (mirrors supervisor data) ──
    _workers = [
      HodWorker(
        id: 'ATT-001',
        name: 'John Doe',
        ...
        checkInTime: DateTime(DateTime.now().year, DateTime.now().month,
            DateTime.now().day, 8, 45),
        checkOutMethod: 'Face Recognition',
        checkOutTime: DateTime(DateTime.now().year, DateTime.now().month,
            DateTime.now().day, 17, 15),
        aadharNumber: '900000000001',
        faceId: 'FACE-johndoe',
        biometricId: 'BIO-johndoe',
      ...
      HodWorker(
        ...
        checkInTime: DateTime(DateTime.now().year, DateTime.now().month,
            DateTime.now().day, 9, 5),
        aadharNumber: '900000000002',
        faceId: 'FACE-janesmith',
        biometricId: 'BIO-janesmith',
      ...
      HodWorker(
        ...
        faceId: 'FACE-robertjohnson',
        biometricId: 'BIO-robertjohnson',
      ...
      HodWorker(
        ...
        baseStatus: 'active',
        attendanceStatus: 'Present',
        checkInMethod: 'Manual + Photo',
        checkInTime: DateTime(DateTime.now().year, DateTime.now().month,
            DateTime.now().day, 8, 55),
        aadharNumber: '900000000004',
        faceId: 'FACE-mariagarcia',
        biometricId: 'BIO-mariagarcia',
      ...
      HodWorker(
        ...
        aadharNumber: '900000000005',
        faceId: 'FACE-davidwilson',
        biometricId: 'BIO-davidwilson',
        geofenceVerified: true,
        hodApprovalStatus: 'approved',
      ),
      HodWorker(
        id: 'TMP-1698765432100',
        name: 'Kumar',
        ...
        checkInMethod: 'Manual + Photo',
        checkInTime: DateTime(DateTime.now().year, DateTime.now().month,
            DateTime.now().day, 9, 20),
        isTemporary: true,
        tempId: 'TEMP-543210',
        aadharNumber: '900000000099',
        faceId: 'FACE-kumar',
        biometricId: 'BIO-kumar',
    ...
    _outsideWorkers = [
      HodOutsideWorker(
        ...
        photoEntryPath: 'entry_batch_1698765000000.jpg',
        geoLocation: '12.9716° N, 77.5946° E',
        photoExitPath: 'endshift_OW-001_1698800000000.jpg',
      ),
      HodOutsideWorker(
        id: 'OW-002',
        name: 'Lakshmi',
        ...
        photoEntryPath: 'entry_batch_1698765000000.jpg',
        geoLocation: '12.9716° N, 77.5946° E',
        photoExitPath: 'endshift_OW-002_1698800000000.jpg',
      ),
      HodOutsideWorker(
        id: 'OW-003',
        name: 'Suresh',
        ...
        supplier: 'XYZ Contractors',
        photoEntryPath: 'entry_batch_1698764000000.jpg',
        geoLocation: '12.9716° N, 77.5946° E',
        halfDayPhotoPath: 'halfday_OW-003_1698780000000.jpg',
      ),
      HodOutsideWorker(
        id: 'OW-004',
        name: 'Mani',
    ...
    _confirmedBatches = [
      HodWorkerBatch(
        batchNumber: 1,
        batchId: 'BATCH-1698765000000-morning',
        supplier: 'ABC Suppliers',
        sessionType: 'Full Day',
        workers: [_outsideWorkers[0], _outsideWorkers[1]],
        photoPath: 'entry_batch_1698765000000.jpg',
        geoLocation: '12.9716° N, 77.5946° E',
        createdAt: DateTime.now(),
        shiftState: HodBatchShiftState.shiftEnded,
        endShiftPhotoPath: 'endshift_batch1_1698800000000.jpg',
        endShiftGeoLocation: '12.9716° N, 77.5946° E',
        hodApprovalStatus: 'approved',
      ),
      HodWorkerBatch(
        batchNumber: 2,
        batchId: 'BATCH-1698764000000-morning',
        supplier: 'XYZ Contractors',
        sessionType: 'Morning',
        workers: [_outsideWorkers[2], _outsideWorkers[3]],
        photoPath: 'entry_batch_1698764000000.jpg',
        geoLocation: '12.9716° N, 77.5946° E',
        createdAt: DateTime.now(),
        shiftState: HodBatchShiftState.fullDayActive,
        continuationPhotoPath: 'continuation_batch2_1698780000000.jpg',
        hodApprovalStatus: 'pending',
      ),
    ];

    // ── Permanent worker payments ──
    _paymentWorkers = [
      HodPermanentWorkerPayment(
        id: 'PAY-WRK-001',
        workerId: 'ATT-001',
        ...
        usedAmount: 2000,
        paidAmount: 0,
        paymentMonth: DateTime(DateTime.now().year, DateTime.now().month),
        isPaid: false,
        hodApprovalStatus: 'pending',
        ledger: [
          HodPaymentLedgerEntry(
            id: 'USED-REQ-1698760000000',
            type: 'used_amount_request',
            amount: 2000,
            date: DateTime.now().subtract(const Duration(days: 5)),
            status: 'Completed',
            method: 'UPI Finance Request',
            note: 'Used amount request sent to finance team',
            proofId: 'USED-PROOF-1698760000000',
          ),
        ],
      ),
      HodPermanentWorkerPayment(
        ...
        ledger: [
          HodPaymentLedgerEntry(
            ...
            proofId: 'CASH-PROOF-1698760000001',
          ),
          HodPaymentLedgerEntry(
            id: 'REQ-1698760000002',
            type: 'request',
            amount: 10000,
      ...
      HodPermanentWorkerPayment(
        ...
        ledger: [
          HodPaymentLedgerEntry(
            ...
            method: 'Cash Payment',
            note: 'Cash salary payment completed',
            proofId: 'CASH-PROOF-1698760000003',
          ),
          HodPaymentLedgerEntry(
            id: 'REQ-1698760000004',
            type: 'request',
            amount: 12000,
            date: DateTime.now().subtract(const Duration(days: 1)),
            status: 'Completed',
            ...
            note: 'Request payment sent to finance team',
            proofId: 'REQ-PROOF-1698760000004',
            registeredInMachineIdsBook: true,
          ),
        ],
      ),
    ];

    // ── Supplier bill requests ──
    _supplierRequests = [
      HodSupplierBillRequest(
        id: 'SUP-REQ-001',
        supplierName: 'ABC Suppliers',
        batchIds: ['BATCH-1698765000000-morning'],
        amount: 1200,
        billAmount: 1200,
      ...
      HodSupplierBillRequest(
        id: 'SUP-REQ-002',
        supplierName: 'XYZ Contractors',
        batchIds: ['BATCH-1698764000000-morning'],
        amount: 600,
        billAmount: 600,
        ...
        requestType: 'Supplier Bill',
        status: 'Completed',
        paymentProof: 'PROOF-1698770000000',
        hodApprovalStatus: 'approved',
      ),
    ];
  }
