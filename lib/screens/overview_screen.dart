...
class _OverviewScreenState extends State<OverviewScreen>
  ...
  Widget _buildStatsSection() {
    return Padding(
      ...
      child: Row(
        children: [
          _buildStatCard('Modules', '10', AppTheme.info,
              Icons.dashboard_rounded, 'Available'),
          const SizedBox(width: 10),
          _buildStatCard('Tasks', '$_totalTasks', AppTheme.success,
              Icons.task_alt_rounded, '$_completedTasks done'),
          const SizedBox(width: 10),
          _buildStatCard('Pending', '₹$_pendingAmount', AppTheme.warning,
              Icons.currency_rupee_rounded, 'To collect'),
        ],
      ),
    );
  }
  ...
  Widget _buildStatCard(
      String title, String value, Color color, IconData icon, String sub) {
    return Expanded(
      child: Container(
  ...
  Widget _buildModuleGrid() {
    final modules = [
      ...
      {
        'emoji': '🚜',
        'title': 'New Machine Entry',
        'subtitle': '10 fields · HOD approval',
        'navType': 'bottom',
        'navIndex': 1,
        'color': AppTheme.warning,
        'popularity': 95
      ...
      {
        'emoji': '📋',
        'title': 'Daily Machines Data',
        'subtitle': '7 fields · Daily log',
        'navType': 'bottom',
        'navIndex': 2,
        'color': AppTheme.info,
        'popularity': 88
      },
      {
        'emoji': '🪪',
        'title': 'Attendance',
        'subtitle': 'Face recognition + ID scan',
        'navType': 'bottom',
        'navIndex': 3,
        'color': AppTheme.success,
        'popularity': 92
      },
      {
        ...
        'subtitle': 'User Entry · Diesel tracking',
        'navType': 'route',
        'route': '/stock',
        'color': AppTheme.warning,
        'popularity': 78
      ...
      },
      {
        'emoji': '💰',
        'title': 'Cash',
        'subtitle': 'Payment tracking & balance',
        'navType': 'route',
        'route': '/cash',
        'color': AppTheme.success,
        'popularity': 70
