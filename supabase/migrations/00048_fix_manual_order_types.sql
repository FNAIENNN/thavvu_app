-- ============================================================================
-- Migration 00048: Fix stock_place_multi_order manual-item types.
--
-- stock_items.id is TEXT in the live schema (legacy). v_item_id must be
-- text; the order insert casts to uuid because stock_orders.item_id IS uuid.
-- ============================================================================
