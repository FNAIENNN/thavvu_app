-- ============================================================================
-- Migration 00039: gin_add_to_stock — supply explicit stock_batch_balances.id.
--
-- The live legacy stock_batch_balances table has a TEXT id column with NO
-- default (migration 00021's gen_random_uuid() default never applied because
-- the table pre-existed). Provide gen_random_uuid()::text explicitly.
-- ============================================================================
